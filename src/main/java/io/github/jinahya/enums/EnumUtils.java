...
public class EnumUtils {
    ...
    public static <K, E extends Enum<E>> Map<K, E> mapValuesBy(final Class<E> enumClass,
    ...
    public static <E extends Enum<E>> Map<String, E> mapValuesByNames(final Class<E> enumClass) {
        Objects.requireNonNull(enumClass, "enumClass is null");
